const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./ImagesDashboard-CqxHZGV2.js","./AppLayout.vue_vue_type_script_setup_true_lang-BcQ77D-u.js","./AppLayout-DTZixd91.css","./mediaFilters-Cv4opu4j.js","./AudioDashboard-DewXALBB.js","./PartyManagement-8qwIHHAJ.js","./EncounterManagement-D3r1gUMP.js","./InitiativeTracker-1E35x5S_.js","./BattlemapEditor-fYGzF7zL.js"])))=>i.map(i=>d[i]);
/**
* @vue/shared v3.5.22
...
const routes = [
  {
    ...
    component: () => __vitePreload(() => import("./DirectorySelection-We_ERIJ9.js"), true ? [] : void 0, import.meta.url),
    meta: { title: "Select Directory" }
  },
  {
    path: "/images",
    name: "Images",
    component: () => __vitePreload(() => import("./ImagesDashboard-CqxHZGV2.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0, import.meta.url),
    meta: { title: "Images & Videos" }
  },
  {
    path: "/audio",
    name: "Audio",
    component: () => __vitePreload(() => import("./AudioDashboard-DewXALBB.js"), true ? __vite__mapDeps([4,1,2,3]) : void 0, import.meta.url),
    meta: { title: "Audio" }
  },
  {
    path: "/party",
    name: "Party",
    component: () => __vitePreload(() => import("./PartyManagement-8qwIHHAJ.js"), true ? __vite__mapDeps([5,1,2]) : void 0, import.meta.url),
    meta: { title: "Party Management" }
  },
  {
    path: "/encounters",
    name: "Encounters",
    component: () => __vitePreload(() => import("./EncounterManagement-D3r1gUMP.js"), true ? __vite__mapDeps([6,1,2]) : void 0, import.meta.url),
    meta: { title: "Encounters" }
  },
  {
    path: "/initiative",
    name: "Initiative",
    component: () => __vitePreload(() => import("./InitiativeTracker-1E35x5S_.js"), true ? __vite__mapDeps([7,1,2]) : void 0, import.meta.url),
    meta: { title: "Initiative Tracker" }
  },
  {
    path: "/battlemap",
    name: "Battlemap",
    component: () => __vitePreload(() => import("./BattlemapEditor-fYGzF7zL.js"), true ? __vite__mapDeps([8,1,2]) : void 0, import.meta.url),
    meta: { title: "Battlemap Editor" }
  },
  {
    path: "/display",
    name: "Display",
    component: () => __vitePreload(() => import("./DisplayWindow-B4rq9mwf.js"), true ? [] : void 0, import.meta.url),
...
const _hoisted_1 = { class: "min-h-screen bg-gray-900 text-white" };
...
const useDirectoryStore = /* @__PURE__ */ defineStore("directory", () => {
  const currentDirectory = ref(null);
  const mediaTree = ref(null);
...
const useDisplayStore = /* @__PURE__ */ defineStore("display", () => {
  ...
  async function initialize() {
    try {
      ...
      window.electronAPI.onDisplayStateUpdated((_event, state2) => {
        displayState.value = state2;
      });
    } catch (error) {
  ...
  async function displayMedia(mediaPath, mediaType, mediaSubtype, displayName) {
    try {
  ...
  async function clearElement(elementType, elementPath) {
    try {
  ...
  async function clearAllPortraits() {
    return await clearElement("portraits");
  }
  async function clearPortrait(portraitPath) {
  ...
  async function clearBackgroundSound(soundId) {
    return await clearElement("backgroundSound", soundId);
  }
  async function clearAllBackgroundSounds() {
    return await clearElement("backgroundSound");
  }
  async function clearSoundEffect(effectId) {
    return await clearElement("soundEffect", effectId);
  }
  async function clearAllSoundEffects() {
...
const usePartyStore = /* @__PURE__ */ defineStore("party", () => {
  const partyData = ref({
    name: "My Party",
    members: [],
  ...
  function addMember(member) {
    ...
    partyData.value.updatedAt = (/* @__PURE__ */ new Date()).toISOString();
  }
...
const useEncounterStore = /* @__PURE__ */ defineStore("encounter", () => {
  const currentEncounter = ref(null);
  const encounterFiles = ref([]);
  const isSaving = ref(false);
  const isLoading = ref(false);
  const lastError = ref(null);
  ...
  function createEncounter(name, difficulty) {
  ...
  function addEnemy(enemy) {
    ...
    currentEncounter.value.updatedAt = (/* @__PURE__ */ new Date()).toISOString();
  }
  function updateEnemy(index, updates) {
  ...
  function updateEncounter(updates) {
    if (!currentEncounter.value) {
      return;
    }
    currentEncounter.value = {
  ...
  async function saveEncounter(customFileName) {
    const directoryStore = useDirectoryStore();
    ...
    lastError.value = null;
    try {
      const fileName = customFileName || `${currentEncounter.value.name.replace(/\s+/g, "_").toLowerCase()}_encounter.json`;
  ...
  async function loadEncounter(filePath) {
    isLoading.value = true;
    lastError.value = null;
    try {
  ...
  async function selectAndLoadEncounter() {
    const directoryStore = useDirectoryStore();
    if (!directoryStore.currentDirectory) {
      lastError.value = "No directory selected";
      return false;
...
const useInitiativeStore = /* @__PURE__ */ defineStore("initiative", () => {
  const initiativeData = ref({
    combatants: [],
    currentTurn: 0,
    round: 1,
    isActive: false,
  ...
  const currentCombatant = computed(() => {
    if (initiativeData.value.currentTurn >= 0 && initiativeData.value.currentTurn < initiativeData.value.combatants.length) {
  ...
  function startCombat() {
    ...
    initiativeData.value.updatedAt = (/* @__PURE__ */ new Date()).toISOString();
  }
  function endCombat() {
  ...
  function updateCombatant(id, updates) {
    const index = initiativeData.value.combatants.findIndex((c) => c.id === id);
    if (index !== -1) {
...
const useBattlemapStore = /* @__PURE__ */ defineStore("battlemap", () => {
  const currentBattlemap = ref(null);
  const battlemapFiles = ref([]);
  ...
  function createBattlemap(gridWidth2, gridHeight2, backgroundImage2, name) {
  ...
  function setToken(x, y, token) {
    if (!currentBattlemap.value) {
      return;
    }
    const key = `${x}-${y}`;
    currentBattlemap.value.tokens[key] = token;
    currentBattlemap.value.updatedAt = (/* @__PURE__ */ new Date()).toISOString();
  }
  ...
  function moveToken(fromX, fromY, toX, toY) {
    if (!currentBattlemap.value) {
      return;
    }
  ...
  function updateToken(x, y, updates) {
    if (!currentBattlemap.value) {
      return;
    }
    const key = `${x}-${y}`;
  ...
  function setMovementRadius(radius) {
    if (!currentBattlemap.value) {
      return;
    }
  ...
  function clearMovementRadius() {
    if (!currentBattlemap.value) {
      return;
    }
    currentBattlemap.value.movementRadius = void 0;
    currentBattlemap.value.updatedAt = (/* @__PURE__ */ new Date()).toISOString();
  }
  ...
  function resetZoom() {
    ...
    currentBattlemap.value.zoom = void 0;
    currentBattlemap.value.updatedAt = (/* @__PURE__ */ new Date()).toISOString();
  }
  async function saveBattlemap(customFileName) {
    const directoryStore = useDirectoryStore();
  ...
  async function loadBattlemap(pathToLoad) {
    const directoryStore = useDirectoryStore();
  ...
  async function refreshBattlemapList() {
    const directoryStore = useDirectoryStore();
    if (!directoryStore.currentDirectory) {
  ...
  async function displayBattlemap() {
    if (!currentBattlemap.value) {
