...
ipcMain.handle('display-media', (event, mediaPath, mediaType, mediaSubtype, displayName) => {
  if (displayWindow && !displayWindow.isDestroyed()) {
    const mediaData = { path: mediaPath, type: mediaType, subtype: mediaSubtype, displayName: displayName };
...
ipcMain.handle('clear-display-element', (event, elementType, elementPath = null) => {
